...
# Temporarily disable ADO tool for testing due to azure-devops beta version issues
# The tool will be re-enabled once the stable version is available



def discover_local_mcp_tools() -> list[Callable]:
    """
